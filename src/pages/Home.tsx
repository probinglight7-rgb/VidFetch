...
export default function Home() {
  ...
  return (
    <div className="flex-grow flex flex-col items-center py-8 sm:py-12 px-4 sm:px-6 lg:px-8 relative">
      ...
      <div className="w-full max-w-3xl z-10 space-y-8 sm:space-y-12 mt-4 sm:mt-8">
